(function (window) {
	...
	/**
	 * Loads and initialises the view {@link View}
	 ...
	 * @param {string} (title) Todo content
	 */
	 ...
	 * @param {number} (id)    Todo ID to back up
	 * @param {string} (title) Todo content
	 */
	 ...
	 * @param {object} (checkbox) checkbox for validated status
	 */
